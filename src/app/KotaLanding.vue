...
const schemaData = computed(() => {
  ...
  return {
    ...
    // Masukkan URL spesifik dengan WWW
    url: `https://www.sedotwcjateng.id/sedot-wc-${slug.value}`,
...
// SEO per-halaman, Canonical WWW & Schema Injection
useHead(() => ({
  ...
  // INI TAMBAHAN KUNCI: Paksa Canonical Tag selalu WWW per Kota
  link: kota.value
    ? [
        {
          rel: 'canonical',
          href: `https://www.sedotwcjateng.id/sedot-wc-${slug.value}`,
        },
      ]
    : [],
